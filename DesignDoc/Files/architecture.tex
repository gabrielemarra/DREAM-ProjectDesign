...
\begin{itemize}
	\item on the left to show the exclusive hierarchy relation between User, Agronomist, Policy maker, and Farmer.
	\item on the right with all the other relations. 
\end{itemize}

The hierarchy relation between Report, FarmerReport, and AgronomistReport is exclusive.
